...
<img src="/dinanathsj29/npm-node-package-manager-tutorial/raw/master/_images-npm-node-package-manager/2-node-npm-logo-2.png" alt="NPM - Node Package Manager" title="NPM - Node Package Manager" width="200" style="max-width: 100%;">
